try {
	...
	(function(win, document) {
		...
		var last_release_ts = "2022-12-29 14:41:05";  // Last time a file was released from split test
		...
		// List of rtp files
		var rtp_files = {"19625":"latest","19626":"latest"};

		// List of custom tags
		var rtp_default_tags = {"MediaNet":["19625"],"Main":["19626"]};

		// Traffic Percentages
		var traffic_percentages = {"19625":0.5,"19626":0.5};
...
window.properSpecialOps = window.properSpecialOps || {};window.properSpecialOps.country='RU';window.properSpecialOps.region='KLU';window.properSpecialOps.uspcDoesApply = false;window.properSpecialOps.gdprDoesApply = false;